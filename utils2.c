...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/10/14 13:11:17 by hbasheer          #+#    #+#             */
/*   Updated: 2024/10/14 13:11:18 by hbasheer         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	zoom_fractal(t_data *fractol, int mouse_x, int mouse_y, int key)
{
	...
	if (key == MOUSE_LMB)
		...
		fractol->zoom *= 1.2;
	screen_x = (convert_range(-2, 2, mouse_x) * fractol->zoom)
		+ fractol->shift_x;
	screen_y = (convert_range(-2, 2, mouse_y) * fractol->zoom)
		+ fractol->shift_y;
